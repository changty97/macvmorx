...
type Config struct {
	...
	// Removed GitHub App specific configurations
}
...
func LoadConfig() *Config {
	cfg := &Config{
		...
		OfflineTimeout:                getEnvDuration("MACVMORX_OFFLINE_TIMEOUT", 45*time.Second), // Increased for 15-30s heartbeats
...
// No longer directly used in config, but keeping as a utility.
